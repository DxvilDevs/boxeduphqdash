(() => {
  ...
  function renderTable(root, tracker) {
    ...
    const issueColumns = `
      <colgroup><col style="width:280px"><col style="width:175px"><col style="width:145px"><col style="width:110px"><col style="width:135px"><col style="width:120px"><col style="width:145px"><col style="width:160px"><col style="width:150px"></colgroup>
      <thead><tr><th>Aa &nbsp; Issue</th><th>👥 &nbsp; Assigned to</th><th>◷ &nbsp; Created time</th><th>◷ &nbsp; Days open</th><th>▣ &nbsp; Due date</th><th>◉ &nbsp; Priority</th><th>◌ &nbsp; Status</th><th>☷ &nbsp; Type</th><th>◫ &nbsp; Progress</th></tr></thead>`;
    const taskColumns = `
      <colgroup><col style="width:275px"><col style="width:145px"><col style="width:160px"><col style="width:130px"><col style="width:110px"><col style="width:160px"><col style="width:150px"><col style="width:275px"><col style="width:145px"><col style="width:125px"></colgroup>
      <thead><tr><th>Aa &nbsp; Task name</th><th>◌ &nbsp; Status</th><th>👥 &nbsp; Assignee</th><th>▣ &nbsp; Due date</th><th>◉ &nbsp; Priority</th><th>◒ &nbsp; Task type</th><th>◫ &nbsp; Progress</th><th>☰ &nbsp; Description</th><th>◷ &nbsp; Updated at</th><th>⌛ &nbsp; Effort level</th></tr></thead>`;
    ...
    root.innerHTML = `
      <div class="table-wrap"><table class="data-table">
        ...
        <tbody>
          ...
          ${canCreateItems() ? `<tr class="new-row" data-action="new-item" data-tracker="${tracker.id}" data-status="Not started"><td colspan="${preset === 'issues' ? 9 : 10}">＋ &nbsp; New ${preset === 'issues' ? 'issue' : 'task'}</td></tr>` : ''}
        </tbody>
      </table></div>`;
  }
  ...
  function issueRow(item) {
    return `<tr>
      ...
      <td data-label="Progress">${tableProgressCell(item)}</td>
    </tr>`;
  }
  ...
  function tableProgressCell(item) {
    const progress = itemProgress(item);
    const checklist = itemChecklist(item);
    const completed = checklist.filter(entry => entry.done).length;
    const detail = checklist.length ? `${completed}/${checklist.length} checklist items complete` : 'No checklist items';
    return `<div class="table-progress-cell" title="${esc(detail)}">
      <div class="progress table-progress"><span style="width:${progress}%"></span></div>
