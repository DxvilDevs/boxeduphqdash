      ...
      <div class="app-shell">
        ...
        <main class="main">
          ...
          <nav class="mobile-dock" aria-label="Mobile navigation">
            ...
            <button data-action="toggle-sidebar"><span>☰</span><small>Trackers</small></button>
            ${canCreateItems() && state.trackers[0] ? `<button class="dock-add" data-action="new-item" data-tracker="${state.trackers[0].id}" data-status="Not started"><span>＋</span><small>Add</small></button>` : ''}
            <button data-route="team"><span>👥</span><small>Team</small></button>
